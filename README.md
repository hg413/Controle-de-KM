...
2. Importe o banco de dados (o setup é automático ao rodar os scripts PHP se configurado).
3. Configure as credenciais no arquivo `backend/database/connection.php`.
